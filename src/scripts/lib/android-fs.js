...
const PUBLIC_SUBDIR = "DREYHOUSE PLAYER"
...
/**
 * Drop a binary file directly into the public Downloads/DREYHOUSE PLAYER/
...
/**
 * Drop a text file directly into the public Downloads/DREYHOUSE PLAYER/
 * folder via MediaStore. No picker UI - used as a fallback when the SAF
 * "Save As" picker is unavailable on the device.
 *
 * @returns the on-device path (best effort) or the URI string of the
