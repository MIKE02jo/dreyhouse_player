...
const PROMO_BUTTONS = [
  { label: "Get DREYHOUSE PLAYER", url: "https://github.com/MIKE02jo/dreyhouse_player/releases/latest" },
  { label: "View on GitHub", url: "https://github.com/MIKE02jo/dreyhouse_player" },
]
